...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.swipe').on('touchend', function (e) {
    if (touchmoved === true) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-home').toggleClass('show');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.hero').toggleClass('height-0');
    }

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('touched');
  }).on('touchmove', function (e) {
    touchmoved = true;
  }).on('touchstart', function () {
    touchmoved = false;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('touched');
  });
});
